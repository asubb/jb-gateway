...
# Usage:
#   ./smb-connect.sh view [host]                     - View available shares
#   ./smb-connect.sh mount <share> <mountpoint> [host] - Mount a share to a local directory
...
case "$1" in
    ...
    *)
        echo "Usage:"
        echo "  $0 view [host]                     - View available shares"
        echo "  $0 mount <share> <mountpoint> [host] - Mount a share to a local directory"
        echo ""
        echo "Example:"
